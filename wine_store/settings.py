...
ALLOWED_HOSTS = [
    "8000-vlocean-winery-uggiijnwaln.ws.codeinstitute-ide.net",
    ".herokuapp.com",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # for media if product doesn't have image
                "django.template.context_processors.media",
                # makes this content available to the entire application
...
if "USE_AWS" in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = "wine-store-a6f954e88a3f"
